...
<body>
	...
	<section class="section3">
		...
		<div id="all">
			<div id="graph">
			<!-- 연도 및 월 선택 드롭다운 -->
			<label for="yearSelectForecast">연도 선택: </label> <select
				id="yearSelectForecast">
				<option value="2024">2024년</option>
			</select> <label for="monthSelectForecast">월 선택: </label> <select
				id="monthSelectForecast">
			...
			<div class="chart-table-container">
				<!-- 차트를 표시할 캔버스 -->
				<canvas id="forecastStatisticsChart" width="400" height="330"></canvas>
			</div>
			</div>
			<div id="tableSection">
				<!-- 수요 예측 통계 테이블 -->
