...
/* aside CSS */
aside #items .item .material-symbols-outlined{
    font-size: 14px;
...
aside #items .item a:link{
    color: inherit;
    text-decoration: none;
}

aside #items .item a:visited{
    color: inherit;
    text-decoration: none;
}
...
#section #content #file .material-symbols-outlined {
    font-size: 20px;
...
table thead{
 ...
 table tbody td:not(.book){
    text-align: center;
}

 table tbody .bookTitle{
    padding-left: 10px;
    font-size: 20px;
    font-weight: 900;
    padding-bottom: 5px;
 ...
 table tbody .wirter span{
   margin-right: 8px;
}

 table tbody .bookCover img{
    width: 60px;
}
